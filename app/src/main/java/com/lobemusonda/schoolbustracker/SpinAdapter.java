...
public class SpinAdapter extends ArrayAdapter<BusStation> {

//    Your sent context
    private Context context;
//    Your custom values for the spinner
//    private BusStation[] values;
    private ArrayList<BusStation> values;


    public SpinAdapter(@NonNull Context context, int textViewResourceId, ArrayList<BusStation> values) {
